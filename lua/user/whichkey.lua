...
local mappings = {
  ...
  s = {
    name = "Session",
    s = { "<cmd>PossessionSave ", "Save Session" },
    r = { "<cmd>PossessionLoad ", "Load Session" },
    h = { "<cmd>PossessionShow ", "Show Session" },
    c = { "<cmd>PossessionClose<cr>", "Close Session" },
    d = { "<cmd>PossessionDelete ", "Delete Session" },
    l = { "<cmd>PossessionList<cr>", "List Session" },
  ...
  f = {
    ...
    p = { "<cmd>Telescope possession list<cr>", "Session list" },
  ...
  l = {
    ...
    f = { "<cmd>lua vim.lsp.buf.format({ async = true })<cr>", "Format" }, -- from null-ls
